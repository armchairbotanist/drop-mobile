...
const CACHE = 'drop-pwa-shell-3348601a884b996d';
const PRECACHE = ["./","./bucket.svg","./manifest.webmanifest","./icon-180.png","./icon-512.png","./assets/pdf.worker.min-CLrFZWeq.mjs","./assets/index-CjGwLpbP.css","./assets/index-DSqM-0OX.js","./assets/pdf-CXgEGMGm.js"];
