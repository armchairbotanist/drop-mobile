...
const CACHE = 'drop-pwa-shell-77247d140b4ebc7b';
const PRECACHE = ["./","./bucket.svg","./manifest.webmanifest","./icon-180.png","./icon-512.png","./assets/pdf.worker.min-CLrFZWeq.mjs","./assets/index-DejAfOt0.css","./assets/index-OpgNE7x8.js","./assets/pdf-DGSyBz4Z.js"];
